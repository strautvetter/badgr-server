...
from mainsite.views import badgeRequestsByBadgeClass, downloadQrCode, deleteLpRequest, requestLearningPath, upload, nounproject, aiskills, requestBadge, deleteBadgeRequest, createCaptchaChallenge, getVersion
